...
| 7 | No frontend tests cover the mode switch or store isolation |
...
| Tests | `test_simulation*.py` (7 modules), `test_general_optimization.py`, `test_target_rescue.py`, `test_response_model.py`, `test_investigation_context.py` |
