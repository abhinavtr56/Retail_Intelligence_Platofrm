      ...
      {tabs.map((t) => {
        ...
        return (
          <button
            ...
            className={`-mb-px inline-flex cursor-pointer items-center gap-1.5 border-b-2 px-4 py-2.5 text-base font-semibold transition-colors duration-150 ${
              isActive
          ...
          >
            ...
            {t.count !== undefined && (
              <span
                className={`rounded-[var(--r-pill)] px-1.5 text-xs font-semibold ${
