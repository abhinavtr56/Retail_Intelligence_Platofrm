...
export function ProgressStrip({
  ...
  return (
    <Card className="fade-in mt-4 grid grid-cols-[2fr_1fr_1fr_1.4fr_auto] items-center gap-6 p-[18px_22px] max-[1000px]:grid-cols-1 max-[1000px]:gap-4">
      <div>
      ...
      <div>
        <div className="text-[11px] font-semibold text-ink-muted">Confidence Score</div>
        <div className="mt-0.5 inline-flex items-center gap-1 text-[22px] font-extrabold text-status-success [font-variant-numeric:tabular-nums] [&_svg]:h-3.5 [&_svg]:w-3.5">
          {confidence}% <Icon name="arrowUp" />
        </div>
        <div className="mt-0.5 text-[11px] text-status-success">↑ {confidenceDelta} vs last run</div>
      </div>
