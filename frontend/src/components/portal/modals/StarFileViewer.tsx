  ...
  return (
    <Modal open onClose={onClose} maxWidthClassName="max-w-[min(1100px,94vw)]">
      <div className="flex items-center justify-between gap-3 border-b border-border-subtle p-[16px_20px]">
        <div className="flex min-w-0 items-center gap-2.5">
          ...
          <div className="min-w-0">
            <h3 className="truncate text-[15px] font-bold">{data?.label ?? 'Loading…'}</h3>
      ...
      <div className="max-h-[64vh] overflow-auto">
        ...
        {preview.isError && (
          <div className="m-5 rounded-[var(--r-md)] bg-status-danger-bg p-[10px_12px] text-[11.5px] leading-[1.55] text-[#B91C1C]">
